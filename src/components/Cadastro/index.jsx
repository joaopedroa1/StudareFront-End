                        ...
                        <div className='formElogin'>
                            <div className='formularioCadastro'>
                                <form className='preencher'>
                                    ...
                                    <input value={emailUsuario} onChange={(e) =>{setEmailUsuario(e.target.value)}} type="text" className='campo email' placeholder='E-mail' />
                                    <input value={senhaUsuario} onChange={(e) => {setSenhaUsuario(e.target.value)}} type="password" className='campo senha' placeholder='Senha' />
                                    <input type="password" className='campo confirmaSenha' placeholder='Confirmar senha' />
